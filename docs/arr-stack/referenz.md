...
SQP steht für [Special Quality Profiles](https://trash-guides.info/SQP/) der TRaSH Guides — feiner abgestimmte Profile, die sich vor allem in der **Quelle** (WEB / Bluray-Encode / Remux), der **Audio-Haltung** und der **HDR/DV-Strategie** unterscheiden. Bei uns ist nur ein Teil als Radarr-Profil angelegt: **SQP-1 (1080p)** und **SQP-5** aktiv, **SQP-3** für wenige Titel.

Die Definition der einzelnen Varianten (SQP-1 bis SQP-5) steht auf der eigenen Seite: [SQP-Familie](./sqp-familie.md).
