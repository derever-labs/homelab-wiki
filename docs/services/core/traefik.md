...
CrowdSec läuft als Bouncer-Plugin in Traefik und blockiert automatisch IP-Adressen bei erkannten Angriffen (Brute-Force, Scans). Details zur CrowdSec-Integration: [CrowdSec](../../platforms/crowdsec.md)
...
- [Traefik Middleware Chains](../../platforms/traefik-middlewares.md) -- Vollständige Middleware-Dokumentation
- [CrowdSec](../../platforms/crowdsec.md) -- IP-Blocking und Threat Intelligence
- [DNS-Architektur](../../platforms/dns-architecture.md) -- DNS-Auflösung für *.ackermannprivat.ch
- [OpenLDAP & Benutzerverwaltung](./ldap.md) -- Keycloak/LDAP-Stack auf derselben VM
- [Netzwerk-Topologie](../../architecture/network-topology.md) -- Netzwerkarchitektur und Routing