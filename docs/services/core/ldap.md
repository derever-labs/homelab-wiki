...
Die Gruppenverwaltung erfolgt in Keycloak (Realm `traefik`), nicht in LDAP. Siehe [Zugriffsgruppen](../../platforms/security.md#zugriffsgruppen) fuer die Gruppenstruktur.
