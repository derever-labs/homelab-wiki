...
- **NFS-Verzeichnis:** `/nfs/docker/vaultwarden` wird zusätzlich durch die allgemeine [Backup-Strategie](../core/backup-strategy.md) abgedeckt
...
- [NAS-Speicher](../../infrastructure/storage-nas.md) -- Litestream-Replikationsziel
