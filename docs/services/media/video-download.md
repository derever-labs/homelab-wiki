...
- [Stash](./stash.md) -- Media Organizer, empfaengt Downloads von special-Instanzen
- [Jellyfin](./jellyfin.md) -- Media Player, empfaengt Downloads von youtube-dl
- [Content Pipeline](./content-pipeline.md) -- Automatisierte Downloads (Batch Jobs)
