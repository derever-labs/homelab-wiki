...
Stash ist der zentrale Media Organizer fuer heruntergeladene Inhalte. Die Batch Jobs ([Content Pipeline](./content-pipeline.md)) laden neue Medien herunter und triggern anschliessend ueber die Stash GraphQL-API automatisch einen Library Scan und die Generierung von Vorschaubildern, Sprites und Thumbnails.
...
Die Haupt-Instanz nutzt ein Linstor CSI Volume (`stash-data`) fuer die Konfiguration und SQLite-Datenbank. Das erfordert, dass der Job auf einem Linstor Storage Node (`vm-nomad-client-05` oder `06`) laeuft. Siehe [Linstor](../../platforms/linstor-drbd.md) fuer Details zum CSI-Setup.
...
- [Content Pipeline](./content-pipeline.md) -- Batch Jobs die Stash fuettern
- [Video-Download-Tools](./video-download.md) -- Manuelle Download-UIs
- [Arr-Stack](./arr-stack.md) -- Medien-Automatisierung (Sonarr, Radarr, etc.)
- [Jellyfin](./jellyfin.md) -- Media Player
- [Linstor](../../platforms/linstor-drbd.md) -- CSI Storage fuer die Haupt-Instanz
