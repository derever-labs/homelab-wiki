...
- **E-Mail:** Über den zentralen [SMTP Relay](../core/smtp-relay.md) (smtp.service.consul:25)
...
- **Backup:** Die gesamte VM wird täglich vom [Proxmox Backup Server](../core/pbs.md) gesichert

## Verwandte Seiten

- [Monitoring Stack](./stack.md) -- Grafana, Loki, Uptime Kuma und Alloy für Metriken und Logs
- [Gatus](./gatus.md) -- Öffentliche Status-Seite für Endpoint-Verfügbarkeit
- [SMTP Relay](../core/smtp-relay.md) -- Mail-Versand für CheckMK-Alerts
- [Proxmox Backup Server](../core/pbs.md) -- VM-Backup von CheckMK