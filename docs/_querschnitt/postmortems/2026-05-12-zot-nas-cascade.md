...
- **PostgreSQL Alert-Rules** (3+1) zur Früherkennung von Connection-Storm (parallel zur Authentik #20714 Mitigation) -- siehe [Datenbank-Architektur](../datenbank-architektur.md)
...
- **Restrisiko akzeptiert:** Single-PSU NAS bleibt -- USV-Plan IT 2026 deckt das ab ([USV-Plan](../../monitoring/ups/index.md))
...
- [ups/index.md](../../monitoring/ups/index.md) -- USV-Plan, deckt das Single-PSU-Restrisiko des NAS ab
- [_querschnitt/datenbank-architektur.md](../datenbank-architektur.md) -- PostgreSQL Alert-Rules zur Connection-Storm-Früherkennung
- [_querschnitt/incident-template.md](../incident-template.md) -- Vorlage für Postmortems und Incident-Dokumentation
