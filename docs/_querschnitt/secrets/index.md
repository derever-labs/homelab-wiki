...
- [Secrets-Architektur](../secrets-architecture.md) -- Bootstrap-Trust und 1Password-zu-Vault-Migration
- [Vault](../../plattform/vault/) -- Cluster-Secret-Store für Service-Secrets zur Laufzeit
- [Claude-Task-Tracking](../claude-task-tracking.md) -- ClickUp-Integration für Claude-Sessions
