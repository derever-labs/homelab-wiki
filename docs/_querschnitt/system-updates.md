...
description: Konsolidierte Ansible-Playbooks für apt-Updates auf Linux-VMs und Proxmox-Hypervisor mit Pre-Update-Snapshots, HA-Maintenance und Quorum-Schutz
tags:
  - querschnitt
  - ansible
  - proxmox
