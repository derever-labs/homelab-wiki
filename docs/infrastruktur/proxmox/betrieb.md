...
PDM nutzt bewusst **kein** `accept-routes`. Würde es die Homelab-Subnet-Route `10.0.0.0/22` übernehmen, würde PDM sein eigenes Netz über Tailscale routen und sich aussperren (und die lokalen lenzburg/pbs-Remotes brechen). Die externen Nodes erreicht PDM daher über die direkte Tailscale-Peer-IP -- die Node-FQDNs lösen entsprechend auf die Tailscale-IPs auf. Details: [Tailscale -- Self-Subnet-Lockout](../../netz/netzwerk/tailscale.md#externe-proxmox-nodes).
:::
...
- [Netzwerk](../../netz/netzwerk/) -- VLANs, VIPs und Routing im Homelab
