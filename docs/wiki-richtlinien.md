...
- **R4 Nummerierung:** Fluss-Diagramme nummerieren die Schrittkette des Szenarios in den Kantenlabels. Dauerhafter Hintergrund- und Kontrollverkehr (Raft, Gossip, Health-Sync, JWKS) darf unnummeriert bleiben, sofern er über die Neben-/Grau-Klasse (R8) klar als Nebenweg gekennzeichnet ist.
