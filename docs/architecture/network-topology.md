...
description: VLANs, Subnets und Routing im Homelab
tags:
  - architecture
  - network
  - vlan
...
Folgende Details fehlen noch und müssen ergänzt werden:
...
Vollständige DNS-Architektur: [DNS-Architektur](../platforms/dns-architecture.md)
...
Details: Siehe `homelab-hashicorp-stack/docs/THUNDERBOLT_NETWORKING.md`
