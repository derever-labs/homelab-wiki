...
Keep Mobile wird nach dem [Homelab-App-Standard](../../_querschnitt/app-standard/) ausgeliefert: ein Commit ins App-Repo baut das Image und oeffnet einen SHA-Bump-PR auf `homelab-nomad-jobs`; der Merge startet den Nomad-Deploy mit Health-Gate und `auto_revert`. Job-Details und Traefik-Tags stehen in `monitoring/keep-mobile.nomad`.

## Verwandte Dokumentation

- [Keep](index.md) -- Incident-Hub und Alert-Routing
- [Homelab-App-Standard](../../_querschnitt/app-standard/) -- Build-/Deploy-Pattern und Auth-Muster
