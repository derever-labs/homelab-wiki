...
Die Rules melden wie alle metrikbasierten Alerts per Webhook an [Keep](../keep/index.md), das nach Severity ins Telegram-Topic routet.
...
- [Monitoring Stack](../index.md) -- Grafana, Telegraf, InfluxDB, Alerting-Architektur
- [Synology NAS Monitoring](../synology-monitoring/index.md) -- NAS-Hardware-Health via CheckMK
- [Proxmox](../../infrastruktur/proxmox/index.md) -- Virtualisierungsplattform (Hosts, VMs)
